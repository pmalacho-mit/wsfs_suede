...
<Dialog.Root bind:open>
  <Dialog.Content class="max-h-[80dvh] gap-0 overflow-hidden p-0 sm:max-w-lg">
    <Dialog.Header class="border-b px-5 py-4">
      ...
      <Dialog.Description>
        ...
        unsent and unaccepted writes. Putting one back is a new change, not an
        undo.
      </Dialog.Description>
    </Dialog.Header>

    <div class="min-h-0 overflow-auto px-2 py-2" data-region="history">
      {#if !told}
        <p
